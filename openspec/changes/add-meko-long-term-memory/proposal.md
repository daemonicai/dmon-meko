...
- **Version alignment**: `ModelContextProtocol` pulls in `Microsoft.Extensions.AI.Abstractions`; align it to dmon-core's **10.5.1** M.E.AI pin to avoid an ABI mismatch.
